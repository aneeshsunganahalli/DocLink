      ...
      <div className='bg-white px-8 py-8 border-none shadow-lg rounded-2xl w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex-1 flex flex-col gap-1'>
              <p>Experience</p>
              <select onChange={(e) => setExperience(e.target.value)}  className='border rounded px-3 py-2'>
        ...
        <button type='submit' className=' mt-3 bg-primary px-10 py-3 text-white rounded-full hover:scale-105 transition-all duration-300'>
          Add Doctor
        </button>
      </div>
    </form>
